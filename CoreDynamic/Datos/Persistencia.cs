...
namespace CoreDynamic
{
    ...
    {
        public Persistencia(int id, Persona persona, decimal porcentaje, int mes_cierrre, int anio_cierre, DateTime fecha_Inicial, DateTime fecha_Final, int cantidad_Contratos, int contratos_Solventes)
        {
            Id = id;
